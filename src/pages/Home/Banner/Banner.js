...
const Banner = () => {
    return (
        <div className='container mx-auto mt-20'>
            <div className='flex'>
                <div>
                    <h2 className='font-semibold text-7xl tracking-wide'>Top Web and Mobile App Development Company.</h2>
                    ...
                    <p className='mt-7 font-semibold text-3xl'>Talk with our experts for 30 <br /> minutes of free product <br />
                        consultation!</p>
                ...
                <div>
                    ...
                    <span className='text-4xl font-semibold'>Celebrating 5 Years of <br /> Success!</span>
                </div>
            </div>
        </div>
    );
